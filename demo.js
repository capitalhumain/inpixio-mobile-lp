...
app.config(function($routeProvider) {
  ...
  $routeProvider.otherwise({redirectTo: 'https://inpixio.com'});
});
...
$scope.isMobileDevice =  (typeof window.orientation !== "undefined") || (navigator.userAgent.indexOf('IEMobile') !== -1);
...
if($scope.isMobileDevice){
        ...
        event.preventDefault();
          $window.location.href = 'https://inpixio.com';


}
console.log($scope.isMobileDevice);
...
app.controller('modalController', function($rootScope, $scope) {

  if(window.orientation === 0 ){
    alert("screen orientation has to be change") ;
  }
  var mediaQueryRule = window.matchMedia("(orientation: portrait)")
 //mediaQueryRule.onchange = function(){ alert("screen orientation changed") }
 window.onorientationchange = function() {
